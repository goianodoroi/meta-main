  ...
  /* ── 1. Wayfarer Gen 2 ──────────────────────────────────────────────────── */
  {
    ...
    colors: [
      ...
      },
      {
        ...
        swatch: '#1A3FA8',
        image: m('Wayfarer (Gen 2)', 'Azul Cósmico Brilhante', '01.mp4'),
        images: [
          m('Wayfarer (Gen 2)', 'Azul Cósmico Brilhante', '02.webp'),
      ...
      },
      {
        ...
        swatch: '#1A3D22',
        image: m('Wayfarer (Gen 2)', 'Preto brilhante transitions transparente a verde grafite', '01.mp4'),
        images: [
          m('Wayfarer (Gen 2)', 'Preto brilhante transitions transparente a verde grafite', '02.webp'),
      ...
      },
      {
        ...
        swatch: '#3A3A3A',
        image: m('Wayfarer (Gen 2)', 'Preto Matte transitions transparente e cinza', '01.mp4'),
        images: [
          m('Wayfarer (Gen 2)', 'Preto Matte transitions transparente e cinza', '02.webp'),
